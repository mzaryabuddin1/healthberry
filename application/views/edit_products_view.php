                        ...
                        <div class="form-body">
                            <div class="row">
                                ...
                                <div class="col-md-6 form-group">
                                    ...
                                    <input type="text" class="form-control" value="<?php echo $data['name'] ?>" name="name" placeholder="Product Name" required>
                                </div>

                                <div class="col-md-6 form-group">
                                    <label>Generic <span class="text-danger">*</span></label>
                                    <input type="text" class="form-control" value="<?php echo $data['generic'] ?>" name="generic" placeholder="Generic" required>
                                </div>
                                <div class="col-md-6 form-group">
                                    <label>Form <span class="text-danger">*</span></label>
                                    <input type="text" class="form-control" value="<?php echo $data['form'] ?>" name="form" placeholder="Form" required>
                                </div>
                                <div class="col-md-6 form-group">
                                    <label>Max Percentage <span class="text-danger">*</span></label>
                                    <input type="text" min="0" max="100" step="0.01" class="form-control" value="<?php echo $data['maxpercentage'] ?>" name="maxpercentage" placeholder="Max Percentage" required>
                                </div>
                                <div class="col-md-6 form-group">
